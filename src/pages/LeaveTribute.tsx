...
import { ImageIcon, X, CheckCircle2, ArrowLeft, ChevronDown } from 'lucide-react';
      ...
      <AnimatePresence mode="wait">
        {!isSuccess ? (
          <motion.div 
            ...
            className="w-full max-w-2xl bg-brand-surface rounded-[24px] p-8 md:p-12 border border-brand-hairline shadow-[0_8px_30px_rgb(0,0,0,0.04)]"
          >
            <div className="text-center mb-10">
              ...
              <h1 className="text-3xl md:text-4xl font-serif tracking-tight text-brand-ink mb-4">
                Leave a Tribute
              </h1>
          ...
          <motion.div 
            ...
            initial={{ opacity: 0, scale: 0.95 }}
            animate={{ opacity: 1, scale: 1 }}
            className="w-full max-w-xl bg-brand-surface rounded-[24px] p-8 md:p-16 border border-brand-hairline shadow-sm text-center"
          >
